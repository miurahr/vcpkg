...
function(vcpkg_test_msbuild)
  ...
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    execute_process(
      ...
      OUTPUT_FILE "${LOGPREFIX}-rel-out.log"
      ERROR_FILE "${LOGPREFIX}-rel-err.log"
      RESULT_VARIABLE error_code
      WORKING_DIRECTORY ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-test/vcpkg-test-source)
    if(error_code)
      message(FATAL_ERROR "Post-build msbuild test(release) failed")
    endif()
  endif()
  if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    execute_process(
      COMMAND msbuild testproject.vcxproj
              ...
              /p:AdditionalIncludePath:${TEST_TARGET_INCLUDE_PATH}
      OUTPUT_FILE "${LOGPREFIX}-dbg-out.log"
      ERROR_FILE "${LOGPREFIX}-dbg-err.log"
      RESULT_VARIABLE error_code
      WORKING_DIRECTORY ${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-test/vcpkg-test-source)
    if(error_code)
      message(FATAL_ERROR "Post-build msbuild test(debug) failed")
    endif()
  endif()
